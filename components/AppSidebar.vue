...
<template>
    ...
    <!-- Component Start -->
    <div @click="ToggleSideBar"  v-show="showSideBar"
         class="flex flex-col items-center w-80 h-full overflow-hidden text-gray-400 bg-gray-900">
    ...
    <div @click="ToggleSideBar"
         v-show="!showSideBar"
         class="flex flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-gray-900">
