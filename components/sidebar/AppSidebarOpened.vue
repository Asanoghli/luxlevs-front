...
<div class="sidebar-bottom">
  <div class="flex gap-4 w-full mx-3">
    <img @click="ChangeLanguage('ge')" class="size-10" src="/ge.png" alt="ქართული">
    <img @click="ChangeLanguage('en')" class="size-10" src="/uk.png" alt="ქართული">
  </div>
